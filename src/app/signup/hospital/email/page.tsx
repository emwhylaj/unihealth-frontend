...
export default function HospitalEmailSignUpPage() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      toast.success("Account created! Let's set up your facility.");
    ...
    <div className="min-h-screen bg-[#0a0f0a] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-[#1a2a1a] border border-[#2d4a2d] rounded-2xl p-8 shadow-2xl">
          <div className="mb-6">
            <div className="inline-flex items-center gap-2 bg-[#4ade80]/10 border border-[#4ade80]/20 text-[#4ade80] text-xs px-3 py-1.5 rounded-full mb-3">
            ...
            <p className="text-gray-400 text-sm">
              Fill in your details to register your facility account
            </p>
          </div>
